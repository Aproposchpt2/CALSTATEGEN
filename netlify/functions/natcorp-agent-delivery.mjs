import { deliveryAgent, getRun, internalAuthorized, json } from './_shared/natcorp-runtime.mjs';
export default async (req) => {
  ...
  try {
    ...
    const output = await deliveryAgent({ runId:body.run_id, run, input:body.input || {} });
