import { intelligenceAgent, getRun, internalAuthorized, json } from './_shared/natcorp-runtime.mjs';
export default async (req) => {
  ...
  try {
    ...
    const output = await intelligenceAgent({ runId:body.run_id, run, input:body.input || {} });
